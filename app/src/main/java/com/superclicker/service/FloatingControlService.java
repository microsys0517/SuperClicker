...
public class FloatingControlService extends Service {
    ...
    private void createFloatingView() {
        ...
        floatingView.findViewById(R.id.btn_floating_play).setOnClickListener(v -> {
            Intent i = new Intent("com.superclicker.ACTION_PLAY");
            sendBroadcast(i);
        });
        floatingView.findViewById(R.id.btn_floating_pause).setOnClickListener(v -> {
            if (engine != null) engine.togglePause();
        });
        floatingView.findViewById(R.id.btn_floating_stop).setOnClickListener(v -> {
            if (engine != null) engine.stop();
        });
        floatingView.findViewById(R.id.btn_floating_hide).setOnClickListener(v -> toggleHide());
